...
module.exports = (bot) => {
    ...
    bot.command('profile', (ctx) => {
        const u = getUser(ctx.from.id, ctx.from.first_name, ctx.from.last_name);
    ...
    bot.command('gift', (ctx) => {
        ...
        const sender = getUser(ctx.from.id, ctx.from.first_name, ctx.from.last_name);
        const recipient = getUser(ctx.message.reply_to_message.from.id, ctx.message.reply_to_message.from.first_name, ctx.message.reply_to_message.from.last_name);
